...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public synchronized List<ChatMessage> getAllPosts() {
	...
	public synchronized List<ChatMessage> getAllPostsForUser(int userid, int server, String channel) {
		List<ChatMessage> messages = new ArrayList<ChatMessage>();
	...
	public synchronized List<ChatMessage> getNewPostsForUser(int userid, long postid, int server, String channel) {
		List<ChatMessage> messages = new ArrayList<ChatMessage>();
	    SQLiteDatabase db = this.getWritableDatabase();
