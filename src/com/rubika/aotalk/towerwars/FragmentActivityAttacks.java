 ...
 */
public class FragmentActivityAttacks extends SherlockFragmentActivity {
	private static final String APP_TAG = "--> AnarchyTalk::FragmentActivityAttacks";
    ...
    public static class ListLoader extends AsyncTaskLoader<List<TowerAttack>> {
    	private static String url = "http://towerwars.info/m/HistorySearch.php?d=%s&type=attacks&limit=50&sortorder=desc&chopmethod=last&output=json";
    ...
    public static class DataListFragment extends SherlockListFragment implements LoaderManager.LoaderCallbacks<List<TowerAttack>> {
