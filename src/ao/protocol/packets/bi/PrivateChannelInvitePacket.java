...
public class PrivateChannelInvitePacket extends Packet  {
    ...
    public PrivateChannelInvitePacket(byte[] data, Direction d) throws MalformedPacketException {
    ...
    public String toString() {
        String result = "["+TYPE+"]PrivateChannelInvitePacket: ";
        result +=  Integer.toHexString( m_id );

        return result;
    }   // end toString()
}   // end class PrivateChannelInvitePacket
