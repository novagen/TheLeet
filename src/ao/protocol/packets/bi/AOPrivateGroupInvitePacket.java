/*
 * AOPrivateGroupInvitePacket.java
 *
...
public class AOPrivateGroupInvitePacket extends AOPacket  {
    ...
    public AOPrivateGroupInvitePacket(int id) {
    ...
    public AOPrivateGroupInvitePacket(byte[] data, Direction d) throws AOMalformedPacketException {
    ...
    public String toString() {
        String result = "AOPrivateGroupInvitePacket: ";
