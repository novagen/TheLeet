...
import ao.protocol.packets.AOMalformedPacketException;
 ...
 * @author Paul Smith
 */
public interface AOPacketFactory {
     ...
     */
    AOPacket toPacket(short type, byte[] data) throws AOMalformedPacketException;
