...
public class PrivateChannelLeavePacket extends Packet {
    ...
    /**
     * Creates a new instance of PrivateChannelLeavePacket
     *
     * @param id
     *        The id of the character hosting the channel
     */
    public PrivateChannelLeavePacket(int id) {
        m_id = id;
     ...
     */
    public PrivateChannelLeavePacket(byte[] data) throws MalformedPacketException {
        if (data == null) {
...
}   // end class PrivateChannelLeavePacket
