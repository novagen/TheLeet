/*
 * AOPrivateGroupKickAllPacket.java
 *
...
public class AOPrivateGroupKickAllPacket extends AOPacket  {

    public static final short TYPE = 54;

    private final byte[] m_data = {};
    
    public AOPrivateGroupKickAllPacket() {
    ...
    public String toString() {
    	return "AOPrivateGroupKickAllPacket";
    }   // end toString()
