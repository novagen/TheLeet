/*
 * AOMalformedPacketException.java
 *
 ...
 * @author Paul Smith
 */
public class AOMalformedPacketException extends IOException {
    
    private final AOUnparsablePacket m_packet;
    
    /** Creates a new instance of AOMalformedPacketException */
    public AOMalformedPacketException(String message, AOUnparsablePacket packet) {
        super(message);
        m_packet = packet;
    }   // end AOMalformedPacketException()
    
    /** Creates a new instance of AOMalformedPacketException */
    public AOMalformedPacketException(String message, Throwable cause, AOUnparsablePacket packet) {
    ...
    public AOUnparsablePacket getPacket() { return m_packet; }
