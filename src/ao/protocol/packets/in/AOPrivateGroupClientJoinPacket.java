/*
 * AOPrivateGroupClientJoinPacket.java
 *
...
public class AOPrivateGroupClientJoinPacket extends AOPacket {
    ...
    public AOPrivateGroupClientJoinPacket(byte[] data) throws AOMalformedPacketException {
    ...
    public String toString() {
        String result = "AOPrivateGroupClientJoinPacket: ";
