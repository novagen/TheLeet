...
/**
 * <p>AOLoginOkPacket is sent from the AO server to the client 
 ...
 */
public class AOLoginOkPacket extends AOPacket {
    
    public static final short TYPE = 5;
    
    private final byte[] m_data = {};
    
    /** Creates a new instance of AOLoginOkPacket */
    public AOLoginOkPacket() {
    ...
    public String toString() {
        return "AOLoginOkPacket";
    }   // end toString()
    
}   // end class AOLoginOkPacket
