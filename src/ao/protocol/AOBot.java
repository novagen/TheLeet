 ...
 */
public interface AOBot extends Runnable {
     ...
     */
    AOPacket nextPacket() throws IOException;
    /**
     ...
     */
    void sendPacket(AOPacket packet) throws IOException;
     ...
     */
    void connect(AODimensionAddress server) throws IOException;
    /**
     ...
     */
    void login(AOCharacter character) throws IOException;
    /**
     * Starts the bot. 
     * 
    ...
    void addListener(AOBotListener l);
    /** Remove a listener from this bot. */
    void removeListener(AOBotListener l);
    /** Adds a logger to this bot. */
    void addLogger(AOBotLogger logger);
    /** Removes a logger from this bot. */
    void removeLogger(AOBotLogger logger);
