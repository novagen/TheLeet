 ...
 */
public class AOBotStateException extends RuntimeException {
    
    private final AOBot.State m_currentState, m_requiredState;
     ...
     */
    public AOBotStateException(String message, AOBot.State currentState, AOBot.State requiredState) {
        super(message);
    ...
    public AOBot.State getCurrentState() { return m_currentState; }
    /** Returns the state that the bot should have been in at the time this exception was thrown. */
    public AOBot.State getRequiredState() { return m_requiredState; }
